...
\begin{itemize}
    \item Operasi ini sebenarnya punya nama: \textbf{Bulgarian Solitaire}. Teknik ini pertama kali dibahas di 1983 Scientific American column oleh Martin Gardner.
...
\begin{claim*} 
    Setelah operasi ke-$N$, banyaknya kotak yang hidup adalah bilangan bulat $k$ terbesar yang memenuhi $T_k = \dfrac{k(k+1)}{2} \le N$.
\end{claim*}
